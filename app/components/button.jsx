  ...
  return (
    <div>
      <a
        ...
        className='flex flex-row items-center justify-center px-10 py-5 mt-5 transition-all duration-200 ease-in border-2 cursor-pointer hover:border-gray-200 border-yellow-400/60'
      >
        <svg
          className='w-8 transition-all duration-200 ease-in mr-7 group_color fill-yellow-400/60'
          viewBox='0 0 16 16'
        ...
        <p className='underline transition-all duration-200 ease-in group_color text-yellow-400/60'>
          {' '}
