  ...
  return (
    <div>
      <style type='text/css'>
        {`
          a:hover>.group_color {
           color:rgba(250 201 40 / 0.6);
            fill:rgba(250 201 40 /0.6)
          }
        `}
      </style>
      <a
        href='Https://wa.me/573044128512'
        className='flex flex-row items-center justify-center px-10 py-5 mt-5 transition-all duration-200 ease-in border-2 border-gray-200 cursor-pointer hover:border-yellow-400/60'
      >
        <svg
          className='w-8 transition-all duration-200 ease-in mr-7 fill-gray-200 group_color'
          viewBox='0 0 16 16'
        ...
        <p className='text-gray-200 underline transition-all duration-200 ease-in group_color'>
          {' '}
